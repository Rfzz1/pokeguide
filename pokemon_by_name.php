...
<body>
    ...
    <nav id="menu-lateral">
        <ul>
            <li><a class="filtro" data-inicio="1" data-fim="9999">Todos</a></li>
            <?php
            foreach ($geracoes as $g => $info):
            ?>
                <li>
                    <a class="filtro" data-inicio="<?= $info['inicio'] ?>" data-fim="<?= $info['fim'] ?>">
                        <?= $info['titulo'] ?>
                    </a>
                </li>
            <?php
    ...
    <div class="header-container">
        <h1 id="titulo">Pokémon por Nome na National Dex</h1>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr data-numero='{$row['numero_national']}'>
